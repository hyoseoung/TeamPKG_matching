...
<body></body>
    ...
    <div class="form-container" align="center">
       <form action="../servlet/UpdateController.do" method="post">
           ...
           <input type="text" id="email_id" class="form_w200" value="${dto.email}" title="이메일 아이디" placeholder="이메일" maxlength="18" readonly/>
         &emsp;<br>
           <label for="name">이름:</label>
           <input type="text" id="name" name="name" value="${dto.memberName}" readonly><br>
